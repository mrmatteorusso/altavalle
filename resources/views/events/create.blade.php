        ...
        <div class="card-body">
            <form action="/events" class="space-y-4" method="POST">
                ...
                <div class="form-control">
                    ...
                    <input id="finishing_time" name="finishing_time" type="text" class="input input-bordered w-full" />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input id="short_description" name="short_description" type="text" class="input input-bordered w-full" />
                </div>
