 <div class="bg-base-100 shadow-xl grid grid-cols-[10fr,15fr,70fr] items-start p-4 w-full mb-8 gap-4">
     <div class="flex flex-col justify-center">
         <p class="text-lg text-white">{{ \Carbon\Carbon::parse($event->event_date)->format('D, d M') }}</p>
     </div>

     <div class="flex justify-center">
         <img class="h-40 w-full object-cover" src="https://via.placeholder.com/640x480.png/0066cc?text=delectus"
             alt="Event" />
     </div>
